...
var megusuri = {
width : 48, height : 27, bpp : 1,
transparent : 0,
buffer : require("heatshrink").decompress((atob("AAcBAokDAokHApEf/EPAoX//4FCgIFBz8AmEH+EP/8MvkPAoW+v0fCIP//1/n4FDj/+AgN/FYP8v/+n/wg4HB+Ef8ED/gyBn/AgH+AoN/AQgICBwIUDh/gIYJcCIIPgNwX8EQQbCD4QkCEQQkCEQQkCEQQkCEQQkCEQQ"))
)};
var shizuku = {
  width : 14, height : 18, bpp : 1,
  transparent : 0,
  buffer : require("heatshrink").decompress((atob("gcAhkAvED+Ef8F/wf/h/8v/5//n/+//4GEx/8CgIbBA="))
)};
var flame = {
...
g.drawString(month + "/" + day + " " + dayOfWeekStr,50,135, true);
  ...
  if (minutes >= 0 && minutes <= 5){
      ...
      g.drawImage(moku,40,mokuY,{scale:0.9});
      g.clearRect(65,90,100,100);
      g.drawImage(coffee,25,80,true);
      g.drawImage(shizuku, 110, shizukuY);
      g.drawImage(megusuri, 95, 61, true);
